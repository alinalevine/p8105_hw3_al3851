...
```{r locations per state, warning = FALSE, message = FALSE}
...
```
 Scores at least as high as good were more common than fair and poor scores. Very good tended to be the most popular. Excellent and very good scores also had the most variability.
...
I am filtering by aisle_id to get the number of items orderd in each aisle
...
```{r mean hour, results = "hide", warning = FALSE, message = FALSE}
