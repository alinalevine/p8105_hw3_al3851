...
##Data Cleaning
```{r clean_brfss, warning = FALSE, message = FALSE}
...
There are `r n_aisles` aisles. I labeled the most popular and least popular aisles, since too many labels would make the plot impossible to read.  
 
#Popular Items

```{r item_count results = "hide", warning = FALSE, message = FALSE}
